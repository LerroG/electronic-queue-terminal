<template>
  <div id="app">
    <router-view @updateLoading="loadingActive()"/>
...
.button {
  ...
  // box-shadow: 0px 5px 10px 10px rgba(211, 211, 211, 0.3) inset;
  // &:active {
  //   box-shadow: 0px 5px 10px 10px rgba(78, 78, 78, 0) inset;
...
@font-face {
  ...
  src: local('Open Sans'), url('./assets/fonts/Open_Sans/OpenSans-Light.ttf') format('truetype');
  font-weight: 300;
}
@font-face {
  font-family: 'Open Sans';
...
@font-face {
  font-family: 'Open Sans';
  src: local('Open Sans'), url('./assets/fonts/Open_Sans/OpenSans-SemiBold.ttf') format('truetype');
  font-weight: 600;
}
@font-face {
  font-family: 'Open Sans';
  src: local('Open Sans'), url('./assets/fonts/Open_Sans/OpenSans-Bold.ttf') format('truetype');
  font-weight: 700;
}
@font-face {
  font-family: 'Open Sans';
  src: local('Open Sans'), url('./assets/fonts/Open_Sans/OpenSans-ExtraBold.ttf') format('truetype');
  font-weight: 800;
}
...
::-webkit-scrollbar-thumb { height: 50px; background-color: #0081CF; border-radius: 3px;}
::-webkit-scrollbar-corner { background-color: #0081CF;}
::-webkit-resizer { background-color: #0081CF;}
